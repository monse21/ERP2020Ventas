    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-info">           
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="Controlador?menu=NuevaVenta&accion=Delete" target="myFrame">NuevaVenta</a><br>
                    </li>
                ...
                <div class="card">
					...
					<thead>
						...
						<tr>   
							...
							<th style="background-color: beige; color:navy">ID</th>
							<th style="background-color: beige; color:navy">NOMBRE</th>
                                                        <th style="background-color: beige; color:navy">Precio</th>
						</tr>
					</thead>
                                        <tbody>
