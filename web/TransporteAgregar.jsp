        ...
        <body> 
            ...
            <div class="d-flex">
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <form onsubmit="return Validar()"action="Controlador?menu=UnidadeTransporte" method="POST">
                                <div class="form-group">
                                    <label>idUnidades de transporte</label>
                                    <input type="text" id="idUnidadesTransporte" value="${Unidad.getDni()}" name="txtDni" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>Nombres</label>
                                    <input type="text" value="${UnidadeTransporte.get}" name="txtNombres" class="form-control" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" >
                                </div>
                                <div class="form-group">
